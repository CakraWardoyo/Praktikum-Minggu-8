...
class MY_Controller extends CI_Controller
{
    ...
    { // Fungsi ini berguna untuk mengecek apakah user sudah login atau belum
        // Pertama kita cek dulu apakah controller saat ini yang sedang diakses user adalah controller Auth apa bukan controller selain controller Auth
    ...
    public function render_login($content, $data = NULL)
    {
        /*
    * $data['contentnya']
    * variabel diatas ^ nantinya akan dikirim ke file
   views/template/login/index.php
    * */
        $data['contentnya'] = $this->load->view(
            $content,
            $data,
            TRUE
        );
    ...
    * variabel diatas ^ nantinya akan dikirim ke file
   views/template/backend/index.php
    * */
